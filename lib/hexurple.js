var Hexurple=function Hexurple(properties){
	...
	this.choices=[
		['black',this.context.hex.toHex(2,+1), true],
		['purple',this.context.hex.toHex(0,+2), undefined],
		['red',this.context.hex.toHex(-2,+3), true],
		['black',this.context.hex.toHex(4,+0), undefined],
		['red',this.context.hex.toHex(-4,+4), undefined],
	]
	
	this.big=this.context.hex.toHex(0,-2)
