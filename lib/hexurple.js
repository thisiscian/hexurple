var Hexurple=function Hexurple(properties){
	...
	this.choices=[
		...
		['purple',this.context.hex.toHex(0,+3), true],
		['red',this.context.hex.toHex(-2,+4), true],
		['black',this.context.hex.toHex(1,1), undefined],
		['red',this.context.hex.toHex(-1,2), undefined],
	]
...
Hexurple.prototype=Object.create(Game.prototype,{
	...
	onMouseUpAfter:{value:function(ev){
		var a=this.context.a.toAbs(ev.clientX,ev.clientY)
